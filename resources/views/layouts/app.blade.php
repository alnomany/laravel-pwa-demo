    ...
    <body>
        ...
        <header>
          ...
          <a href="index.html" class="brand-logo">
            <img src="{{ asset('assets/images/logo.svg')}}" class="img-fluid main-logo" alt="" width="70" height="70">
            <img src="{{ asset('assets/images/logo.svg')}}" class="img-fluid white-logo" alt="">
          </a>
          <form action="" method="POST">
            ...
            <div class="header-option">
                <ul>
                    ...
                    <li>
                        <a href="{{ route('search.all') }}"><i class="iconly-Search icli"></i></a>
                    </li>
          ...
          <ul class="category-slide">
            <li>
              <a href="inner-category.html" class="category-box">
                <img src="assets/images/category/economy1.jpg" class="img-fluid" alt="">
                <h4>أقتصادي</h4>
              </a>
            </li>
            <li>
              <a href="inner-category.html" class="category-box">
                <img src="assets/images/category/polotics.jpg" class="img-fluid" alt="">
                <h4>سياسي</h4>
              </a>
            </li>
            <li>
              <a href="inner-category.html" class="category-box">
                <img src="assets/images/category/sport.jpg" class="img-fluid" alt="">
                <h4>رياضي</h4>
              </a>
            </li>
            <li>
              <a href="inner-category.html" class="category-box">
                <img src="assets/images/category/middle-est.jpg" class="img-fluid" alt="">
                <h4>الشرق الاوسط</h4>
              </a>
            </li>
            <li>
              <a href="inner-category.html" class="category-box">
                <img src="assets/images/category/sec.jpg" class="img-fluid" alt="">
                <h4>أمني</h4>
              </a>
            </li>
