 ...
 public function newsapi(){
    ...
    // $request->Keywords;
      ...
      //  return Excel::download(new NewsExport, 'newsData.xlsx');
        return (new NewsExport)->forYear("تونس")->download('invoices.xlsx');


    }
    public function exportF(){
        return view('reports.exportF');
    ...
    public function export($id)
  {
    ...
    Excel::download('Company List', function($excel) use ($id)
    {
...
// $request->Keywords;
      ...
      ->select('news.*','country_name','source_name')
         ...
         break;
            case 'export':
        return (new NewsExport)->forYear($book)->download('news.xlsx');
        break;
